...
public class ConfigForClient {
    ...
    // реєструє клієнта но використовує не базу а збереження в памяті через InMemoryRegisteredClientRepository
    @Bean
    public RegisteredClientRepository clientRepository(PasswordEncoder passwordEncoder){
        RegisteredClient registeredClient = RegisteredClient.withId(UUID.randomUUID().toString())
                ...
                .redirectUri("http://127.0.0.1:9090/login/oauth2/code/tacocloud")
